...
const PortfolioSection = () => {
  ...
  return (
    <div className="bg-white shadow-sm p-6 border border-[#D6DDEB]">
      ...
      >
        <div className="flex space-x-4 min-w-max pb-2">
          {portfolioItems.map((item, index) => (
            <div
              key={index}
              className="min-w-[200px] max-w-[220px] border border-gray-200 bg-white p-2 shadow-sm hover:shadow-md transition-shadow"
            >
              <div className=" mb-2">
                <Image
