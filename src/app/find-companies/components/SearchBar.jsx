...
export default function SearchBar({
  ...
  const handleSearch = () => {
    ...
    // If onSearchClick is provided, use it (for company search)
    if (onSearchClick) {
      onSearchClick();
    } else {
      // Default behavior for job search
  ...
  useEffect(() => {
    ...
    if (saved) {
      try {
        ...
        console.error(`Error parsing recent searches from ${storageKey}:`, e);
      }
    }
  }, [storageKey]);
